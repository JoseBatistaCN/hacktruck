/*:
 ...
 Para calcular a circunferência de um círculo (o comprimento do contorno), é necessário multiplicar o diâmetro do círculo (a distância entre dois pontos, passando pelo centro) por **ᴨ** (pi).
 
 Este é o valor aproximado de pi:
*/
let pi = 3.14159265359
//: - callout(Exercise):\
//:(Exercício):\
//:Escreva um programa para calcular a circunferência de um círculo com diâmetro igual a 2. Crie uma constante para abrigar o diâmetro. A constante precisa ser de que tipo? 
let PI:Float = 3.14
var diametro:Float = 2
var raio:Float = diametro / 2
